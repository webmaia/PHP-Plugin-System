 ...
 */
  ...
  */
  class Hooks
  {
    ...
    {
      $idx =  $this->_filterBuildUniqueId($tag, $function_to_add, $priority);
    ...
    {
      $function_to_remove = $this->_filterBuildUniqueId($tag, $function_to_remove, $priority);
    ...
    public function hasFilter($tag, $function_to_check = false)
    {
      ...
      if ( !$idx = $this->_filterBuildUniqueId($tag, $function_to_check, false) )
        return false;
     ...
     */
    public function __callAllHook($args)
    {
